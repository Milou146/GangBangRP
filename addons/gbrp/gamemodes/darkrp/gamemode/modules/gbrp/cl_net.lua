...
net.Receive("GBRP::jewelrystoreReception",function()
    ...
    customerArea:SetSize(gbrp.FormatX(369),gbrp.FormatX(126))
...
net.Receive("GBRP::welcomeScreen",function()
    ...
    LoadPage3.init = function()
        ...
        leaderlabel.mat = Material("gui/gbrp/welcomescreen/page3/leaderlabel.png")
...
net.Receive("GBRP::cityhallReception",function()
    ...
    tax.mat = Material("gui/gbrp/cityhall/tax.png")
    tax.hoveredMat = Material("gui/gbrp/cityhall/taxrollover.png")
    ...
    defiscalize.mat = Material("gui/gbrp/cityhall/defiscalize.png")
    defiscalize.hoveredMat = Material("gui/gbrp/cityhall/defiscalizerollover.png")
