...
TCF.Config.Lang = TCF.Config.Lang or {}
...
TCF.Config.Lang["Your stove has exploded and caught fire due to taking an excessive amount of damage!"] = {
	...
	["cn"] = "你的炉子因受到严重损坏而着火了.",
	["tr"] = "Ocaginiz fazla hasar almasi sonucu tutustu ve patladi!",
}
TCF.Config.Lang["Your stove has exploded due to taking an excessive amount of damage!"] = {
	...
	["cn"] = "你的炉子因受到严重损坏而爆炸了",
	["tr"] = "Ocaginiz cok fazla hasar almasi sonucu patladi!",
}
...
TCF.Config.Lang["There is no cooking plate attached. Please purchase a plate for this cooker before turning it on!"] = {
	...
	["tr"] = "Pisirme tabagi yerlestirilmemis. Lutfen bir tane satin alin!",
}
TCF.Config.Lang["There are no gas cans attached to the stove!"] = {
	...
	["cn"] = "炉子上没有煤气罐!",
	["tr"] = "Ocaga bagli hic gaz tupu yok!",
}
TCF.Config.Lang["The cooking plate has been successfully installed on your stove."] = {
	...
	["tr"] = "Pisirme tabagi basariyla ocaga takildi.",
}
TCF.Config.Lang["Your stove cannot fit more cooking plates."] = {
	...
	["cn"] = "你的炉子放不下更多的盘子.",
	["tr"] = "Ocaga daha fazla pisirme tabagi sigmiyor",
}
TCF.Config.Lang["Your stove has ran out of gas and all cooking process has stopped."] = {
	...
	["tr"] = "Ocaginin gazi bitt pisirme islemi durduruldu.",
}
...
TCF.Config.Lang["You have confiscated a box of cocaine. You've been rewarded"] = {
	...
	["cn"] = "你交了一盒可卡因.你得到了奖励",
	["tr"] = "Kokoin kutusuna el koydun. Odullendirildin.",
}
TCF.Config.Lang["Your box packed with cocaine has been closed and is ready for sale at the druggie."] = {
	...
	["tr"] = "Kokoinleri paketledin ve satilmaya hazir durumda.",
}
TCF.Config.Lang["Your box has been opened again. You can put more packed cocaine in it now."] = {
	...
	["tr"] = "Kutu yeniden acildi. Daha fazla kokoin koyabilirsin.",
}
...
TCF.Config.Lang["Cocaine poured out on the drying rack."] = {
	...
	["cn"] = "可卡因倒在晾衣架上",
	["tr"] = "Kokoin kurutmak icin kurutma rafina koydun.",
}
TCF.Config.Lang["The drying process has finished and is now ready."] = {
	...
	["cn"] = "干燥过程已经完成,现在准备就绪",
	["tr"] = "Kuruma islemi tamam ve hazir.",
}
TCF.Config.Lang["Put the cocaine pack in your drug holder box."] = {
	...
	["cn"] = "把可卡因包放在你的箱子里",
	["tr"] = "Kokoin paketini uyusturucu kutusuna koy.",
}
TCF.Config.Lang["The drying rack ran out of battery and failed the process."] = {
	["en"] = "The drying rack ran out of battery and failed the process.",
	["fr"] = "Le rack n'a plus de batterie et le processus a échoué.",
	["da"] = "Tørrings bordet løb tør for batteri og processen slog fejl.",
	["de"] = "Die Batterie des Racks ist leer und der Prozess ist fehlgeschlagen.",
	["pl"] = "W szafie rozładował się akumulator i proces nie powiódł się.",
	["ru"] = "В стойке разрядился аккумулятор, и процесс не прошел.",
	["es"] = "El bastidor se quedó sin batería y falló el proceso.",
	["cn"] = "机架没电了，该过程失败了。",
	["tr"] = "Rafın pili bitti ve işlem başarısız oldu.",
}
TCF.Config.Lang["The machine is currently drying the cocaine!"] = {
	...
	["cn"] = "该机器目前正在烘干可卡因!",
	["tr"] = "Makine su an kokoini kurutuyor!",
}
TCF.Config.Lang["There are no batteries connected to the drying rack!"] = {
	...
	["cn"] = "晾衣架上没有连接电池!",
	["tr"] = "Kurutma rafina bagli hic bir pil yok!",
}
TCF.Config.Lang["Batteries ran out of energy and the drying rack has been turned off!"] = {
	...
	["cn"] = "电池电量耗尽，晾衣架已经关闭!",
	["tr"] = "Pillerin enerjisi bitti ve kurutma raflari kapandi!",
}
TCF.Config.Lang["The drying rack had ran out of energy and failed the process."] = {
	...
	["cn"] = "晾衣架耗尽了能量并且失败了.",
	["tr"] = "Kurutma rafinin enerjisi bitti ve islemeyi durdurdu.",
}
...
TCF.Config.Lang["Your cocaine extractor has exploded and caught fire due to taking an excessive amount of damage!"] = {
	...
	["tr"] = "Kokoin cikarici fazla hasar almasindan tutustu ve patladi!",
}
TCF.Config.Lang["Your cocaine extractor has exploded due to taking an excessive amount of damage!"] = {
	...
	["tr"] = "Kokoin cikarici fazla hasar almasindan dolayi patladi!",
}
TCF.Config.Lang["The machine is already extracting the cocaine!"] = {
	...
	["cn"] = "机器已经在提取可卡因了!",
	["tr"] = "Makine zaten kokoin cikartiyor!",
}
TCF.Config.Lang["There is no bucket attached to the extractor."] = {
	...
	["cn"] = "提取器上没有桶",
	["tr"] = "Cikariciye bagli bir kova yok.",
}
TCF.Config.Lang["There is not enough finished mixture or leaves in the extractor."] = {
	...
	["tr"] = "Cikarici icerisinde yeteri kadar karisim ve yaprak yok.",
}
TCF.Config.Lang["The cocaine has been successfully extracted. The bucket is now ready!"] = {
	...
	["tr"] = "Kokoin basariyla cikarildi. Kova hazir!",
}
TCF.Config.Lang["Bucket successfully attached. You can start the extractor once it's loaded with finished mixture and leaves."] = {
	...
	["tr"] = "Kova basariyla baglandi. Cikariciyi karbonat ve yapraklarini yukledikten sonra baslatabilirsin.",
}
...
TCF.Config.Lang["Your box contains no cocaine. Are you trying to scam me?"] = {
	...
	["tr"] = "Kutu kokoin icermiyor. Beni kaziklamaya mi calisiyosun?",
}
TCF.Config.Lang["Close the box before trying to sell it, rookie."] = {
	...
	["tr"] = "Satmadan once kutuyu kapat, acemi.",
}
TCF.Config.Lang["Please bring the box closer to the druggie."] = {
	...
	["cn"] = "请把箱子扔到NPC脚边",
	["tr"] = "Kokoinmana kutuyu yaklastirin.",
}
TCF.Config.Lang["I don't want to speak with you in your current position, go away!"] = {
	...
	["tr"] = "Su an ki pozisyonunda senle konusmak istemiyorum, uza!",
}
TCF.Config.Lang["You've just sold your cocaine for"] = {
	...
	["cn"] = "你刚刚把可卡因卖了",
	["tr"] = "Kokoinini az once su kadara sattin",
}
...
TURKISH
TCF.Config.RandomHeySentences = { "Heey dostum!", "Yeni bitme napıyosun?", "Napiyosun lan ibine?", "Vay vay kimleri goruyorum burada?", }
--]]
...
TCF.Config.Lang["I see that you have brought me a box with just 1 package?\nThat's not a lot of cocaine, but I will still offer you a minor sum of money for your product."] = {
	...
	["tr"] = "Goruyorum ki icinde 1 paket kokoin olan bi paket getirdin?\nBu yeterli degil ama sana hala az buz da olsa para vericem.",
}
...
TCF.Config.Lang["I see that you have brought me a box with 2 packages?\nSo here is the deal. I'd like to offer you a fair amount of money for your product."] = {
	...
	["tr"] = "Goruyorum ki icinde 2 paket kokoin olan bi paket getirdin?\n Simdi soyle yapalim. Senin urunune gore parani vereyim isimiz bitsin.",
}
...
TCF.Config.Lang["I see that you have brought me a box with 3 packages?\nGreat work!. I would like to offer you a large sum of money for your packages."] = {
	...
	["tr"] = "Goruyorum ki icinde 3 paket kokoin olan bi paket getirdin?\nGuzel guzel... Sana uretiminden dolayi baya bi para vermek istiyorum.",
}
...
TCF.Config.Lang["Ahh finally! I've been waiting for someone to bring me a full load of cocaine.\nI like your style, and would like to offer you a large sum of money for your packages."] = {
	...
	["tr"] = "Ahh evet sonunda! Istedigim sey buydu. Ici kokoin dolu bir paket.\nStilini sevdim ve sana guzel bir teklifim var.Uretiminden dolayi baya bi para vericem.",
}
...
TCF.Config.Lang["Accepting the druggies offer will give you"] = {
	...
	["cn"] = "接受NPC的报价会给你",
	["tr"] = "Kokoinmanin verdigi teklifi kabul edersen su kadar kazanicaksin",
}
TCF.Config.Lang["Decline the druggies offer and leave the shop!"] = {
	...
	["cn"] = "拒绝NPC的报价,离开商店,滚蛋.",
	["tr"] = "Kokoinmanin teklifini reddet ve magzadan cik.",
}
...
--REPAIR WRENCH
TCF.Config.Lang["Repair Wrench (Cocaine Factory)"] = {
	["en"] = "Repair Wrench (Cocaine Factory)",
	["fr"] = "Clé de réparation (Cocaine Factory)",
	["da"] = "Reparationsnøgle (Cocaine Factory)",
	["de"] = "Reparaturschlüssel (Cocaine Factory)",
	["pl"] = "Klucz do naprawy (Cocaine Factory)",
	["ru"] = "Ремонтный ключ (Cocaine Factory)",
	["es"] = "Llave de reparación (Cocaine Factory)",
	["cn"] = "维修扳手 (Cocaine Factory)",
	["tr"] = "Onarım Anahtarı (Cocaine Factory)",
}
TCF.Config.Lang["Left Click: Use repair wrench while aiming at a cocaine entity."] = {
	["en"] = "Left Click: Use repair wrench while aiming at a cocaine entity.",
	["fr"] = "Clic gauche: utilisez une clé de réparation tout en visant une entité cocaïne.",
	["da"] = "Venstre klik: Brug reparationsnøgle, mens du sigter mod en kokainenhed.",
	["de"] = "Linksklick: Verwenden Sie einen Reparaturschlüssel, während Sie auf eine Kokain-Entität zielen.",
	["pl"] = "Kliknięcie lewym przyciskiem: Użyj klucza naprawczego, celując w byt będący kokainą.",
	["ru"] = "Левый щелчок: используйте ремонтный ключ, нацеливаясь на кокаиновую сущность.",
	["es"] = "Clic izquierdo: usa la llave de reparación mientras apuntas a una entidad de cocaína.",
	["cn"] = "左键单击：对准可卡因实体时，请使用维修扳手。",
	["tr"] = "Sol Tıklama: Bir kokain varlığını hedeflerken onarım anahtarını kullanın.",
}
TCF.Config.Lang["Your stove has reached its maximum health!"] = {
	["en"] = "Your stove has reached its maximum health!",
	["fr"] = "Votre poêle a atteint son maximum de santé!",
	["da"] = "Dit komfur har nået sit maksimale helbred!",
	["de"] = "Ihr Ofen hat seine maximale Gesundheit erreicht!",
	["pl"] = "Twój piec osiągnął maksymalne zdrowie!",
	["ru"] = "Ваша плита достигла максимального уровня здоровья!",
	["es"] = "¡Tu estufa ha alcanzado su máxima salud!",
	["cn"] = "您的炉灶已达到最大健康状态！",
	["tr"] = "Ocağınız maksimum sağlığına ulaştı!",
}
TCF.Config.Lang["Your cocaine extractor has reached its maximum health!"] = {
	["en"] = "Your cocaine extractor has reached its maximum health!",
	["fr"] = "Votre extracteur de cocaïne a atteint son maximum de santé!",
	["da"] = "Din kokainekstraktor har nået sit maksimale helbred!",
	["de"] = "Ihr Kokainextraktor hat seine maximale Gesundheit erreicht!",
	["pl"] = "Twój ekstraktor kokainy osiągnął maksymalne zdrowie!",
	["ru"] = "Ваш кокаиновый экстрактор достиг максимального уровня здоровья!",
	["es"] = "¡Tu extractora de cocaína ha alcanzado su máxima salud!",
	["cn"] = "您的可卡因提取器已达到最大健康状态！",
	["tr"] = "Kokain çıkarıcınız maksimum sağlığına ulaştı!",
}
TCF.Config.Lang["Your drying rack has reached its maximum health!"] = {
	["en"] = "Your drying rack has reached its maximum health!",
	["fr"] = "Votre séchoir a atteint son maximum de santé!",
	["da"] = "Din kokain tørringsenhed har nået sit maksimale helbred!",
	["de"] = "Ihr Wäscheständer hat seine maximale Gesundheit erreicht!",
	["pl"] = "Twój stojak do suszenia osiągnął maksymalny stan zdrowia!",
	["ru"] = "Ваша сушилка достигла максимального уровня здоровья!",
	["es"] = "¡Tu tendedero ha alcanzado su máxima salud!",
	["cn"] = "您的晾衣架已达到最大健康状态！",
	["tr"] = "Kurutma rafınız maksimum sağlığına ulaştı!",
}
TCF.Config.Lang["Entity has been healed."] = {
	["en"] = "Entity has been healed.",
	["fr"] = "L'entité a été guérie.",
	["da"] = "Enheden er blevet helbredt.",
	["de"] = "Das Wesen wurde geheilt.",
	["pl"] = "Istota została uzdrowiona.",
	["ru"] = "Сущность исцелена.",
	["es"] = "La entidad ha sido sanada.",
	["cn"] = "实体已被治愈。",
	["tr"] = "Varlık iyileştirildi.",
}
--[[
TCF.Config.Lang[""] = {
	["en"] = "",
