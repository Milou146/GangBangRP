...
function ENT:StartTouch(ent)
    ...
    elseif ent:GetClass() == "cocaine_cooking_pot" then
        -- Check to see if we have water and baking soda in the pot.
        if ent.ReadyToCook then
            for i = 1, 4 do
                if (self.PotsOnStove[i] == nil) then
                    if i == 1 then
                        if not self.CookerOneActive then return end
                    ...
                    elseif i == 2 then
                        if not self.CookerTwoActive then return end
                    ...
                    elseif i == 3 then
                        if not self.CookerThreeActive then return end
                    ...
                    elseif i == 4 then
                        if not self.CookerFourActive then return end
...
function ENT:CoolDown()
    ...
    timer.Create("cooktimer_cooldown" .. ei_, 3, 0, function()
        ...
        elseif self:GetGasAmount() <= 0 then
            -- OUT OF GAS
