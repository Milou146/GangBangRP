...
TEAM_NYPD = DarkRP.createJob("N.Y.P.D", {
    ...
    weapons = {"weapon_tg_fists", "pocket", "keys", "weaponchecker","weapon_frost_lidargun","policebadge"},
    command = "nypd",
    max = 8,
    salary = 10,
    admin = 0,
...
TEAM_NYPD1 = DarkRP.createJob("Commissaire", {
    ...
    weapons = {"weapon_tg_fists", "pocket", "keys", "weaponchecker","weapon_frost_lidargun","door_ram","policebadge"},
    command = "cnypd",
    max = 1,
    salary = 10,
    admin = 0,
...
TEAM_NYPD2 = DarkRP.createJob("S.W.A.T", {
    ...
    weapons = {"weapon_tg_fists", "pocket", "keys", "weaponchecker","policebadge"},
    command = "swat",
    max = 4,
    salary = 10,
    admin = 0,
...
TEAM_NYPD3 = DarkRP.createJob("S.W.A.T Médic", {
    ...
    weapons = {"weapon_tg_fists", "weapon_medkit", "pocket", "keys", "weaponchecker","policebadge"},
    command = "swatmed",
    max = 1,
    salary = 12,
    admin = 0,
...
TEAM_VIP = DarkRP.createJob("YAMAKASI", {
    ...
    weapons = {"climb_swep2", "pocket", "keys","weapon_spraymhs"},
    command = "yama",
    max = 2,
    salary = 0,
    admin = 0,
...
TEAM_VIP4 = DarkRP.createJob("Agent secret", {
    ...
    weapons = {"disguise_swep", "pocket", "keys","policebadgewallet"},
    command = "ags",
    max = 1,
    salary = 0,
    admin = 0,
