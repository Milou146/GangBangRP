...
GM.Config.demotetime = 1800
-- doorcost - Sets the cost of a door.
GM.Config.doorcost = 125000
...
GM.Config.DefaultWeapons = {"keys", "pocket",}
...
GM.Config.AdminWeapons = {"weapon_keypadchecker",}

-- These are the default laws, they're unchangeable in-game.
GM.Config.DefaultLaws = {"Do not attack other citizens except in self-defence.", "Do not steal or break into people's homes.", "Money printers/drugs are illegal.",}
