...
NpcShop_Config.Config_ColorThree = Color(32, 32, 42)



// LANGUAGE SETTINGS | Dont forged spaces



// Gun Dealer Name | DONT REMOVE THE ""
...
// If You need help contact me: twilight-gaming@web.de
