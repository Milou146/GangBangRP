...
hook.Add( "HUDPaint", "WCD::CursorStatus", function()
	...
	if( IsValid( WCD.DesignerUI ) ) then
		...
		draw.SimpleTextOutlined( WCD:Translate( WCD.Lang.dealerVarious.wallet, DarkRP.formatMoney( LocalPlayer():GetNWInt( "GBRP::balance" ) ) ), "WCD::FontDealer", ScrW() / 2, ScrH() - 280, color_white,
			TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 2, color_black );
